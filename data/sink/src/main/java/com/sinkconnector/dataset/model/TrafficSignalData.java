...
public class TrafficSignalData {
	...
	public static Schema schema = SchemaBuilder.struct()
		.name("com.sinkconnector.dataset.model").version(1).doc("Schema for traffic signal data")
	...
	@Override
	public int hashCode() {
		return Objects.hash(regDt, itstId, ntPdsgRmdrCs, etPdsgRmdrCs, stPdsgRmdrCs, wtPdsgRmdrCs, nePdsgRmdrCs,
			sePdsgRmdrCs, swPdsgRmdrCs, nwPdsgRmdrCs);
	}
}